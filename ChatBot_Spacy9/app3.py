...
def greet():
    return jsonify({"message": "Hi there! What legal procedure do you need help with today?"})
...
def get_steps():
    ...
    if case_type:
        ...
        return jsonify({"error": "Sorry, I couldn't find a relevant legal procedure. Please try again!"}), 404
