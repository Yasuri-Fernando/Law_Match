...
def extract_keywords(user_input):
    ...
    logging.info(f"Extracted keywords: {keywords}")  # Debugging print
    return keywords
...
def find_case_type(user_input):
    ...
    logging.info(f"Matched case type: {best_match} (Score: {best_score})")  # Debugging print
    return best_match
...
if __name__ == "__main__":
    app.run(port=5000)  # Keep default port
