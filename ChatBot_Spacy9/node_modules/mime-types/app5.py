...
def find_case_type(user_input):
    ...
    logging.info(f"Matched case type: {best_match} (Score: {best_score})")
    return best_match
...
def get_steps():
    ...
    if not user_input:
        return jsonify({"error": "Oops! Looks like you forgot to enter a procedure. Try again!"}), 400  # Modified error message
